...
using DanielMaldonado.Inquest.Web.Controllers.Results;
using DanielMaldonado.Inquest.Web.Models.Account;
...
{
    public class AccountController : InquestControllerBase
    {
        ...
        #region Guest
        [HttpPost]
        public async Task<JsonResult> Guest(string returnUrl = "", string returnUrlHash = "")
        {
            var loginModel = new LoginViewModel();

            loginModel.Password = "Gu3stUs3rP@ssw0rd";
            loginModel.RememberMe = true;
            loginModel.UsernameOrEmailAddress = "Guest";

            return await this.Login(loginModel, returnUrl, returnUrlHash);
        }
        #endregion
