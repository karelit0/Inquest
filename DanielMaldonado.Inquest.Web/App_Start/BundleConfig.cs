        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(
                new StyleBundle("~/Bundles/App/vendor/css")
                    ...
                    .Include("~/Scripts/ui-select/dist/select.css", new CssRewriteUrlTransform())
                );
            ...
            bundles.Add(
                new ScriptBundle("~/Bundles/App/vendor/js")
                    .Include(
                        ...
                        "~/Scripts/angular-filter-master/dist/angular-filter.min.js",
                        "~/Scripts/smartTable/dist/smart-table.min.js",
                        "~/Scripts/ui-select/dist/select.min.js",
